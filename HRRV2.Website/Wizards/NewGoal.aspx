<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewGoal.aspx.cs" Inherits="HRRV2.Website.Wizards.NewGoal" %>
        ...
        function showStepCallback(obj) {
            ...
            if (step_num == 4) {
                ...
                if (finalGoalWeights.innerHTML == "") {
                    loadGoalWeights(JSON.stringify({ ID: $("#enteredForID").val()}), finalGoalWeights, function () {
