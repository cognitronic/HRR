var webserver = 'http://hrrv2.localhost/';
...
function loadGoalWeights(userID, container, callback) {
    $.ajax({
        type: "POST",
        url: webserver + "api/Staff/GetGoalsForWeightingByPersonID",
        cache: false,
        data: userID,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function saveGoal(goalJson) {
    $.ajax({
        type: "POST",
        url: webserver + "api/Staff/SaveGoal",
        data: goalJson,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function saveEmployee(newperson) {
    alert(newperson);
    $.ajax({
        type: "POST",
        url: webserver + "api/Staff/SavePerson",
        data: newperson,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function closeReview(review) {
    $.ajax({
        type: "POST",
        url: webserver + "api/Staff/CloseReview",
        data: review,
...
function saveWeights(weights) {
    $.ajax({
        type: "POST",
        url: webserver + "api/Staff/UpdateGoalWeight",
        data: weights,
        contentType: "application/json;",
        dataType: "json",
        success: function (data) {
