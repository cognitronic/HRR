...
{
    public class TeamUsersDDL : DropDownList
    {
        public TeamUsersDDL()
        {
            LoadUsers();
        ...
        public void LoadUsers()
        {
            ...
            if (SecurityContextManager.Current != null)
            {
                ...
                {
                    foreach (var s in new TeamMemberServices().GetByTeamID((int)SecurityContextManager.Current.CurrentTeamID).OrderBy(o => o.PersonRef.LastName))
                    {
