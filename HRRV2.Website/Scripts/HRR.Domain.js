...
function Comment() {
    ...
    this.EnteredFor = 0;
    this.Message = "";
    this.FollowUpResolution = "";
    this.ReasonNotIncludedInReview = "";
    this.EnteredBy = 0;
    this.DateCreated = dateToWcf(CurrentDate());
    this.FollowUpDate = dateToWcf(CurrentDate());
    this.Communication = [];
    this.Likes = 0;
...
function PerformanceEvaluationTemplateQuestion() {
    this.ID = 0;
    this.PerformanceEvaluationTemplateID = 0;
    this.Question = "";
    this.IsSlider = false;
    this.ChangedBy = 0;
    this.LastUpdated = dateToWcf(CurrentDate());
...
function PerformanceEvaluationSliderValue() {
    this.ID = 0;
    this.PerformanceEvaluationTemplateQuestionID = 0;
    this.Title = "";
    this.Value = 0;
    this.ChangedBy = 0;
    this.LastUpdated = dateToWcf(CurrentDate());
