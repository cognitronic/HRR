...
<telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server"  Skin="Simple" Transparency="15" />
    ...
    <div class="three_fourth last_column" runat="server" id="divTabs">
            <div>
                                    ...
                                    Skin="Metro">
                                        ...
                                        NoMasterRecordsText="No Reviews Found.">
                                            <Columns>
                                                ...
                                                UniqueName="Title">
                                                    <ItemTemplate>
                                                        <a href="/Reviews/<%# Eval("ID") %>"><%#  Eval("Title")%></a> 
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn 
                                                DataField="DueDate" 
                                                ...
                                                UniqueName="StatusID">
                                                    <ItemTemplate>
                                                        ...
                                                        height:2em; ">
                                                            <idea:Label
                                                                runat="server"
                                                                ID="lblProgressText" class="progresslabelingrid" style="margin-top: -25px !important;"/>
                                                        </div>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                            </Columns>
