...
namespace HRRV2.Website.Views
{
    ...
    public partial class GoalMilestoneView : System.Web.UI.UserControl
    {
        ...
        private HRR.Core.Domain.Goal CurrentGoal
        {
            get
            {
                return ((EditGoal)this.Parent.Page).CurrentGoal;
            }
        }
        ...
        {
            SaveMilestone();
            HttpPageHelper.UpdateTabs((EditGoal)this.Parent.Page);
        }
        ...
        private void SaveMilestone()
        {
            ...
            m.EnteredFor = ((EditGoal)this.Parent.Page).CurrentProfile.ID;
            m.GoalID = ((EditGoal)this.Parent.Page).CurrentGoal.ID;
            m.IsAccepted = true;
            ...
            this.CurrentGoal.StatusID = ((EditGoal)this.Parent.Page).CalculateProgress();
