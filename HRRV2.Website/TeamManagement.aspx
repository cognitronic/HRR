<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="TeamManagement.aspx.cs" Inherits="HRRV2.Website.TeamManaqement" %>
                ...
                Skin="Metro">
                    ...
                    NoMasterRecordsText="No Members Assigned.">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn 
                            DataField="HasAccess" 
                            HeaderText="Has Access" 
                            SortExpression="HasAccess"
                            UniqueName="HasAccess">
                                <ItemTemplate>
                                    <%# Eval("HasAccess").ToString().Equals("True") ? "Yes" : "No"%>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <idea:CheckBox
                                    runat="server"
                                    ID="cbHasAccess"
                                    Checked='<%# Eval("HasAccess") %>' />
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn 
                            DataField="RecievesNotifications" 
